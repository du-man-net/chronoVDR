...
export function get_modal_del_datas(title, message) {
    let nodal_title = document.getElementById('modal_del_datas_title');
    nodal_title.innerHTML = "";
    let mytitle = document.createTextNode(title);
    nodal_title.appendChild(mytitle);
    let nodal_message = document.getElementById('modal_del_datas_body');
    nodal_message.innerHTML = "";
    let mymessage = document.createTextNode(message);
    nodal_message.appendChild(mymessage);
    const modal_del_datas = new bootstrap.Modal(document.getElementById('modal_del_datas'));
    return modal_del_datas;
}

export function get_modal_del_ativite(title, message) {
    let nodal_title = document.getElementById('modal_del_ativite_title');
    nodal_title.innerHTML = "";
    let mytitle = document.createTextNode(title);
    nodal_title.appendChild(mytitle);
    let nodal_message = document.getElementById('modal_del_ativite_body');
    nodal_message.innerHTML = "";
    let mymessage = document.createTextNode(message);
    nodal_message.appendChild(mymessage);
    const modal_del_ativite = new bootstrap.Modal(document.getElementById('modal_del_ativite'));
    return modal_del_ativite;
}
...
export function get_modal_alert(title, message) {
    ...
    let mymessage = document.createTextNode(message);
    nodal_message.appendChild(mymessage);
    const modal_alert = new bootstrap.Modal(document.getElementById('modal_alert'));
    return modal_alert;
}

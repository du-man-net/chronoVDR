...
import { get_modal_alert, get_modal_conf, showOffcanvasProps, showOffcanvasMenu, showOffcanvasToAdd } from './ui.js';
...
//****************************************
    ...
    document.getElementById('del_activite').addEventListener('click', function (e) {
        let title = "Supprimer l'activité";
        let message = "Vous allez supprimer l'activité ***" + myActivite.nom + "*** et toutes les données !";
        document.getElementById("btn_modal_conf").addEventListener("click", function removeA(e) {
            myActivites.remove(loadToAdd);
            mymodal.hide();
            removeEventListener('click', removeA);
        });
        showOffcanvasProps(false);
        let mymodal = get_modal_conf(title, message);
        mymodal.show();
    });
    ...
    //****************************************
    document.getElementById('del_datas').addEventListener('click', function (e) {
        let title = "Supprimer ldes données";
        let message = "Vous allez supprimer toute les données de l'activité ***" + myActivite.nom + "*** !";
        document.getElementById("btn_modal_conf").addEventListener("click", function delDatas(e) {
            myActivite.delete_datas();
            mymodal.hide();
            removeEventListener('click', delDatas);
        });
        showOffcanvasProps(false);
        let mymodal = get_modal_conf(title, message);
        mymodal.show();

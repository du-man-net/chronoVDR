...
//                        align: 'center'
    ...
    insertCharts(id) {
        ...
        if (r) {
            ...
            let canvas = cell.children[0].children[0];
        ...
        if (this.charts[id]) {
            ...
            if (this.check(flags.TIME_PER_LAP)) {
                if (labels.length > 1) {
                    ...
                    this.charts[id].data.datasets[0].data.push(diff);
                } else {
                    this.charts[id].data.datasets[0].data.push(0);
                }
            } else {
                this.charts[id].data.datasets[0].data.push(item['y']);
            }
        }
    }
